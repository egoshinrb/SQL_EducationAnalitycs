...
Анализ и статистика данных по учебной деятельности студентов школы 55.
...
Вам нужно будет создать базу данных со знаниями о Школе 55 и написать процедуры и функции для получения информации, а также процедуры и триггеры для её изменения.
